namespace BMS.Core
{
    ...
    public class Motor : NetworkBehaviour
    {
        ...
        public CameraController m_cameraControllerPrefab;
        ...
        public override void OnStartClient()
        {
            ...
            if (!IsOwner)
            {
                ...
                Destroy(m_cameraControllerPrefab.gameObject);
                Destroy(this);
            }
        }
        ...
        {
            if (m_cameraControllerPrefab)
            {
                m_cameraControllerPrefab = Instantiate(m_cameraControllerPrefab);
                m_cameraControllerPrefab.m_player = transform;
            }
        }
        ...
        private void ApplyGravity()
        {
            ...
            // TODO: Check for moving platforms
        }
        ...
        public void MoveRotation(Quaternion rot, Space space)
        {
        ...
        {
            Debug.Log("On ground surface: " + ground.Transform.gameObject.name);
        ...
        /// </summary>
        private void OnWallEnterInternal()
        {
        ...
        /// </summary>
        private void OnWallExitInternal()
        {
